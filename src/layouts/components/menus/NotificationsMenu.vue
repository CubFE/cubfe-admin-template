<template>
    <div>
        ...
        <!-- <div class="m-l-4 p-2.5 rounded-full cursor-pointer text-gray-400 hover:text-primary hover:bg-gray-100" @click="isOpen=true">
            <span class="sr-only">View App List</span>
            <Squares2X2Icon class="h-6 w-6" aria-hidden="true" />
        </div> -->
        <div  class="p-2 rounded-full cursor-pointer text-gray-400  hover:bg-gray-100 dark:hover:bg-dark-sidebar" @click="isOpen=true">
                ...
                <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10 pt-16 sm:pl-16">
                    ...
                    <DialogPanel class="pointer-events-auto w-screen max-w-md ">
                        <div class="flex h-full flex-col overflow-y-scroll bg-white dark:bg-dark-sidebar shadow-xl">
                            ...
                            <DialogTitle class="text-base font-semibold leading-6 text-gray-900 dark:text-white">Team</DialogTitle>
                            <div class="ml-3 flex h-7 items-center">
                                <div class="rounded-full cursor-pointer bg-white text-gray-400 hover:text-gray-500 focus:ring-2 focus:ring-indigo-500" @click="isOpen = false">
