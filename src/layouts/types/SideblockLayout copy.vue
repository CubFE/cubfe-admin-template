<template>
  <div class="h-full">
    ...
    <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:flex-col" :class="[sidebarOpen?'w-60': 'w-20']">
      <!-- Sidebar component, swap this element with another sidebar if you like -->
      <Sideblock />
    </div>

    <div class="fixed top-0 w-full h-full" :class="[sidebarOpen?'pl-60': 'pl-20']">
      <div
      ...
      <main class="h-full overflow-y-scroll">
        <div class="px-10 py-10 h-full bg-stone-100 dark:bg-dark-main-bg text-slate-200 lg:py-10 " 
          :class="[widthMode == 'fluid' ? `w-full lg:px-10` : (noBoxedLyout.includes(layout)?'w-full lg:px-10':'lg:px-60')]">
          <!-- Main area -->
